...
Path B · Research Use Only · `clinical_validation=false` · freeze tip `v2.1-proxy-hyp-benches` + Auditor DUAL-GATE (CODEX-111; hospital demo pack tip still `v2.0-hospital-demo-ready`)  
